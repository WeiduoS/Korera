...
-- -----------------------------------------------------
-- Table `mydb`.`pro_res_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`pro_res_mapping` ;

CREATE TABLE IF NOT EXISTS `mydb`.`pro_res_mapping` (
...
-- -----------------------------------------------------
-- Table `mydb`.`proj_addition_columns`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`proj_addition_columns` ;

CREATE TABLE IF NOT EXISTS `mydb`.`proj_addition_columns` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `column` VARCHAR(45) NULL,
  `val` VARCHAR(45) NULL,
  `project_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_proj_addition_columns_Project1_idx` (`project_id` ASC),
  CONSTRAINT `fk_proj_addition_columns_Project1`
    FOREIGN KEY (`project_id`)
    REFERENCES `mydb`.`Project` (`project_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
